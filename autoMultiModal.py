...
class CameraManager(object):
    ...
    def _parse_image(weak_self, image):
        ...
        if self.sensors[self.index][0].startswith('sensor.lidar'):
            ...
            array = array[:, :, :3]
            array = array[:, :, ::-1]
            self.raw_image = cv2.cvtColor(array, cv2.COLOR_BGR2RGB)  # added
...
def game_loop(args):
    ...
    try:
        ...
        # LIDAR Sensor Window
        lidar_bp = generate_lidar_bp(world.world.get_blueprint_library(), 0.05)
        lidar_transform = carla.Transform(carla.Location(x=-0.5, z=1.8))
        lidar = world.world.spawn_actor(lidar_bp, lidar_transform, attach_to=world.player)
        ...
        with tf.Session(graph=graph) as sess:
            while True:
                ...
                raw_image = world.camera_manager.raw_image
                ...
                utils.draw_bounding_boxes(pygame, display, raw_image, bboxes)
